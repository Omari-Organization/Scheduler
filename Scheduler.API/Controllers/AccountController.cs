...
namespace Scheduler.API.Controllers
{
    ...
    {
        private IdentityRepository _identityRepo = null;
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            IdentityUser user = await _identityRepo.FindAsync(new UserLoginInfo(externalLogin.LoginProvider, externalLogin.ProviderKey));
